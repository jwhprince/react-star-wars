...
// alt
export const SWAPI_ROOTT = 'swapi.py4e.com/api/';
export const SWAPI_PEOPLEE = 'people';
export const SWAPI_PARAM_PAGEE = '/?page=';
export const SWAPI_PARAM_SEARCHH = '/?search=';

export const API_PEOPLEE = HTTPS + SWAPI_ROOTT + SWAPI_PEOPLEE + SWAPI_PARAM_PAGEE;
export const API_PERSONN = HTTPS + SWAPI_ROOTT + SWAPI_PEOPLEE;
export const API_SEARCHH = HTTPS + SWAPI_ROOTT + SWAPI_PEOPLEE + SWAPI_PARAM_SEARCHH;
